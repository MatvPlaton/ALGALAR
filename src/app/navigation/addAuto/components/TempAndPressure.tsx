...
} from './styles/TempAndPressure';
import AnyFieldoutlined from './AnyFieldoutlined';
import { FieldWrapper } from './styles/TempAndPressure';
import Image from 'next/image';
import temp from '@/app/assets/AddAuto/tempIcon.svg';
import bar from '@/app/assets/AddAuto/barIcon.svg';
interface Stats {
  number: string;
  size: string;
  ngp: string;
