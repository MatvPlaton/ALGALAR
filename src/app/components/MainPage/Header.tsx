    ...
    <div className="absolute w-full h-[10rem] bg-black text-white flex">
      <div className="w-[32rem] h-3/5 translate-x-[-50%] relative left-1/3 top-[15%] flex max-w-[65vw] max-h-[34vh]">
        ...
        <div className="relative left-[5%]">
          <div className="relative max-[385px]:text-[1.8rem] h-1/2 w-full text-left text-[2.3rem] font-extrabold font-[InterExtraBold]">
            ALGALAR
          </div>
          <div className="relative max-[481px]:w-[1%] h-1/2 text-[1.2rem] font-extrabold font-[InterExtraBold]">
