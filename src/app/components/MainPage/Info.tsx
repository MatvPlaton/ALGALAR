...
const Info = () => {
  return (
    ...
    max-[1281px]:h-[120rem]
    max-[1098px]:top-[calc(30rem+55vh)] max-[769px]:h-[180rem]
    max-[961px]:h-[150rem]
    max-[481px]:top-[calc(34rem+55vh)] max-[481px]:h-[220rem]">
      
      <InfoTitle />
      
      <div className="absolute w-[55vw] h-[50rem] top-1/5 left-1/10 flex flex-col max-[769px]:top-[13%]">
