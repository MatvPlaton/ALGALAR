...
import Background from '../../assets/MainPage/new.svg';
  ...
  return (
    <div className="absolute w-full top-[10rem] h-[55vh] left-0 z-10 bg-[#383838]">
      ...
      max-[481px]:flex-col max-[481px]:h-[24rem]">
        ...
        <div
          className="relative text-[#C5C5C5] text-left 
          left-[18.5%] top-[20%] w-[30vw] text-[1.4rem] font-[RobotoRegular] line-height-[2rem]
