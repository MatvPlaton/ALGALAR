...
const ForgotPassword = () => {
  return (
    <Link className="flex items-center justify-center absolute bottom-1/5 left-[1%] bg-white w-[10rem] h-[2.5rem] 
    ...
    hover:bg-[#c4c2c3] active:translate-y-[-5%] " href={'/auth/forgotPassword'}>
