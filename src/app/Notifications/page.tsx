...
const Notifications = () => {
    ...
    <TitleBox />
    <ListBox active={active} setActive={setActive} index={currNot} setIndex={setCurrNot}/>
    <InfoBox currIndex={currNot}  setActive={setActive} active={active} setCurrIndex={setCurrNot}/>
    </div>
}
